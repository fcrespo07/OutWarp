...
- Split tunnelling, DDNS, auto-update del servidor, Prometheus, más idiomas: features; caben en 1.x sin romper nada. (Multi-perfil salió de esta lista el 2026-09-25: toca la forma de `config.json`.)
