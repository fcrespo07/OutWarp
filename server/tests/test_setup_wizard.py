...
class TestTransportBranch:
    ...
    def _run(self, tmp_path: Path, *, use_domain: bool, prompts: list[str]):
        ...
        with (
            ...
            patch("outwarp_server.service_install.get_server_platform", return_value=platform),
            ...
            patch("outwarp_server.service_install.configure_ufw_if_active", return_value=False),
            patch("outwarp_server.service_install.enable_ip_forwarding"),
